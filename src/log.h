...
extern void log_startup(const char *,uint32,const char *,int);

extern void log_query(uint64 *,const char *,unsigned int,const char *,const char *,const char *,const char *);
extern void log_querydrop(uint64 *,const char *);
extern void log_querydone(uint64 *,unsigned int,const char *);
...
extern void log_tx(const char *,const char *,const char *,const char *,int,unsigned int);

extern void log_nxdomain(const char *,const char *,unsigned int);
extern void log_nodata(const char *,const char *,const char *,unsigned int);
extern void log_servfail(const char *);
extern void log_servflag(const char *,int);
